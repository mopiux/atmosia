...
/**
 * Parámetros de una capa de nubes (Sección 2 del documento de diseño).
 *
 * Las tres capas no son tres planos independientes: comparten el mismo campo de ruido con escalas
 * y cortes distintos, así que donde coinciden la densidad se acumula y se lee como una masa más
 * profunda en vez de como tres láminas superpuestas.
 *
 * @param name        identificador para logs y métricas
 ...
 * @param coverage    cuánto cielo cubre, 0..1. Más alto, más nube.
 * @param noiseScale  bloques por unidad de ruido. Más alto, formaciones más grandes.
 */
public record CloudLayerDef(
    ...
    /**
     * Capa alta: dispersa y sutil, gris levemente azulado, la más rápida.
     * Las velocidades distintas por capa son lo que produce la sensación de profundidad cuando se
     ...
     *
     * El movimiento se resuelve con este offset y nunca regenerando geometría: las regiones viven
     * en espacio de nube, no en espacio de mundo, así que su densidad no cambia jamás y lo único
     * que se mueve es dónde se dibujan (Sección 5.1).
     */
